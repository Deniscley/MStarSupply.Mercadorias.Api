using MStarSupply.Core.DomainExcetion;
using System;
...
namespace MStarSupply.Core.Validacoes
{
    public class Validations
    {
        ...
        // Validar Data
        public static void ValidateData(DateTime? data, string mensagem)
        {
            if (!data.HasValue)
            {
                throw new DomainException(mensagem);
